# AGENT.md - CBC-Stratagems 仓库工作指引

## 仓库定位

CBC-Stratagems 是一个代码实现仓库，目标是在 Minecraft 中实现类似 HELLDIVERS 2 的战略配备呼叫系统，并基于 CreateBigCannons (CBC) 完成火力打击。
...
- 不要修改或复制 CBC 源码，除非后续明确决定以依赖、接口或适配层方式处
- 理。
